...
from datasets import PMD
from datasets import GSD
...
def setup_loaders(args):
    ...
    if args.dataset == 'PMD':
        train_set = args.dataset_cls.PMDDateset(
        ...
        val_set = args.dataset_cls.PMDDateset(
            'semantic', 'test', 0,
        ...
        train_set = args.dataset_cls.GSDDateset(
            'semantic', 'train', args.maxSkip,
            joint_transform_list=train_joint_transform_list,
            transform=train_input_transform,
            target_transform=target_train_transform,
        ...
        val_set = args.dataset_cls.GSDDateset(
            'semantic', 'test', 0,
            joint_transform_list=val_joint_transform_list,
            transform=val_input_transform,
            target_transform=target_transform,
        ...
        train_set = args.dataset_cls.Trans10kDataset(
            'semantic', 'train', args.maxSkip,
            joint_transform_list=train_joint_transform_list,
            transform=train_input_transform,
            target_transform=target_train_transform,
            ...
            edge_map=True,
            thicky=args.thicky)
        val_set = args.dataset_cls.Trans10kDataset(
